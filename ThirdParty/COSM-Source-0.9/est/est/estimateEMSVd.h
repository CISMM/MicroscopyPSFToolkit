 ...
 *
 ****************************************************************************/
#ifndef _ESTIMATE_EMSV_H
#define _ESTIMATE_EMSV_H
...
class EstimateEMSV : public EstimateIterative<T,N> {
  ...
  private:
    ...
    // not allowed
    EstimateEMSV( EstimateEMSV<T,N>& );
    void operator=( EstimateEMSV<T,N>& );
...
#include "estimateEMSV.c"

#endif  // _ESTIMATE_EMSV_H
