 ...
 *
 ****************************************************************************/
#ifndef _ESTIMATE_EMOS2_H
#define _ESTIMATE_EMOS2_H
...
class EstimateEMOS2 : public EstimateIterative<T,N> {
  ...
  private:
    ...
    // not allowed
    EstimateEMOS2( EstimateEMOS2<T,N>& );
    void operator=( EstimateEMOS2<T,N>& );
...
#include "estimateEMOS2.c"

#endif  // _ESTIMATE_EMOS2_H
