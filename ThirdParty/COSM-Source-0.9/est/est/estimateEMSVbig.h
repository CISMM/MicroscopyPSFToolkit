 ...
 *
 ****************************************************************************/
#ifndef _ESTIMATE_EMSV_BIG_H
#define _ESTIMATE_EMSV_BIG_H
...
class EstimateEMSVbig : public EstimateIterative<T,N> {
  ...
  private:
    ...
    // not allowed
    EstimateEMSVbig( EstimateEMSVbig<T,N>& );
    void operator=( EstimateEMSVbig<T,N>& );
...
#include "estimateEMSVbig.c"

#endif  // _ESTIMATE_EMSV_BIG_H
