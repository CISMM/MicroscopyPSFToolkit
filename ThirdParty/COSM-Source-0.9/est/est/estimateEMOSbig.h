 ...
 *
 ****************************************************************************/
#ifndef _ESTIMATE_EMOS_BIG_H
#define _ESTIMATE_EMOS_BIG_H
...
class EstimateEMOSbig : public EstimateIterative<T,N> {
  ...
  private:
    ...
    // not allowed
    EstimateEMOSbig( EstimateEMOSbig<T,N>& );
    void operator=( EstimateEMOSbig<T,N>& );
...
#include "estimateEMOSbig.c"

#endif  // _ESTIMATE_EMOS_BIG_H
