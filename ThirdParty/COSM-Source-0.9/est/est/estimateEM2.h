 ...
 *
 ****************************************************************************/
#ifndef _ESTIMATE_EM2_H
#define _ESTIMATE_EM2_H
...
class EstimateEM2 : public EstimateIterative<T,N> {
  ...
  private:
    ...
    // not allowed
    EstimateEM2( EstimateEM2<T,N>& );
    void operator=( EstimateEM2<T,N>& );
  ...
  private:
    ...
    Array<T,N> est2_;   	        // estimate with double first dim

};

}

#include "estimateEM2.c"


#endif  // _ESTIMATE_EM2_H
